  ...
  return (
    <>
      ...
      <div className={`fixed inset-0 z-[1200] items-center justify-center bg-slate-950/95 p-3 sm:p-6 ${isOpen ? 'flex' : 'hidden'}`} role="dialog" aria-modal="true" aria-label="AI-Quant Lab product promo">
        <div className="relative aspect-video h-auto w-full max-w-[min(96vw,calc(100vh*1.7778))] overflow-hidden rounded-2xl border border-cyan-300/65 bg-slate-950 shadow-[0_0_90px_rgba(34,211,238,0.45)]">
