...
const particles = [
  ...
  { className: 'left-[3%] top-[54%] h-2.5 w-2.5', delay: '4s', duration: '3.2s' },
  { className: 'left-[15%] top-[26%] h-1.5 w-1.5', delay: '4.2s', duration: '3.4s' },
  { className: 'left-[26%] top-[60%] h-2.5 w-2.5', delay: '4.4s', duration: '3.1s' },
  { className: 'left-[41%] top-[20%] h-1.5 w-1.5', delay: '4.6s', duration: '3.3s' },
  { className: 'left-[49%] top-[54%] h-2.5 w-2.5', delay: '4.8s', duration: '3.2s' },
  { className: 'left-[62%] top-[24%] h-1.5 w-1.5', delay: '5s', duration: '3.4s' },
  { className: 'left-[70%] top-[62%] h-2.5 w-2.5', delay: '5.2s', duration: '3.1s' },
  { className: 'left-[79%] top-[10%] h-1.5 w-1.5', delay: '5.4s', duration: '3.3s' },
  { className: 'left-[90%] top-[50%] h-2.5 w-2.5', delay: '5.6s', duration: '3.2s' },
  { className: 'left-[96%] top-[24%] h-1.5 w-1.5', delay: '5.8s', duration: '3.4s' },
  { className: 'left-[5%] top-[86%] h-2.5 w-2.5', delay: '6s', duration: '3.1s' },
  { className: 'left-[14%] top-[38%] h-1.5 w-1.5', delay: '6.2s', duration: '3.3s' },
  { className: 'left-[23%] top-[12%] h-2.5 w-2.5', delay: '6.4s', duration: '3.2s' },
  { className: 'left-[33%] top-[74%] h-1.5 w-1.5', delay: '6.6s', duration: '3.4s' },
  { className: 'left-[43%] top-[46%] h-2.5 w-2.5', delay: '6.8s', duration: '3.1s' },
  { className: 'left-[52%] top-[82%] h-1.5 w-1.5', delay: '7s', duration: '3.3s' },
  { className: 'left-[61%] top-[36%] h-2.5 w-2.5', delay: '7.2s', duration: '3.2s' },
  { className: 'left-[71%] top-[90%] h-1.5 w-1.5', delay: '7.4s', duration: '3.4s' },
  { className: 'left-[83%] top-[46%] h-2.5 w-2.5', delay: '7.6s', duration: '3.1s' },
  { className: 'left-[92%] top-[14%] h-1.5 w-1.5', delay: '7.8s', duration: '3.3s' },
];
