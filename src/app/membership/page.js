...
Object.assign(copy, {
  ja: { metadataTitle: '標準メンバーシップ MVP', badge: 'STANDARD MEMBERSHIP MVP', title: '標準メンバーシップ', accent: '実際に使える最小実用版', description: 'この版ではログイン、決済、Webhook による更新、メンバーセンターを一つの完全な会員フローとして接続しています。', setupTitle: '設定状況', flowTitle: '利用の流れ', mvpTitle: 'MVP に関する注意', signup: 'アカウントを作成', signin: 'すでにアカウントをお持ちですか？ログイン', checkout: 'サブスクリプション決済へ', clerkBox: 'Clerk の本人認証／登録', lemonBox: 'Lemon Squeezy のサブスクリプション決済', supabaseBox: 'Supabase 会員状態の同期', memberBox: 'メンバーセンターと保護ページ', ready: '準備完了', pending: '未設定', stepTitles: ['1. 会員 ID を作成', '2. サブスクリプション決済を完了', '3. 会員アクセスを有効化'], stepTexts: ['Clerk でログイン用アカウントを作成します。以後の会員状態はメールアドレスに紐付きます。', '公式の Lemon Squeezy サブスクリプションページで決済を完了すると、結果は自動的に Supabase へ反映されます。', 'Webhook の処理後、会員状態は active になり、利用可能な状態を確認できます。'], mvpNote: 'Lemon Squeezy の checkout と webhook の接続は準備済みです。本番の決済 URL と webhook secret はデプロイ環境に設定してください。', banners: { clerk: 'Clerk 設定: ログイン、登録、本人確認が完了していることを確認してください。', lemon: 'Lemon Squeezy 設定: checkout URL と webhook secret を入力してください。', error: '一部の設定が不足しています。Clerk、Lemon Squeezy、Supabase の設定を確認してください。' }, details: { clerkReady: 'ログイン、登録、本人確認を利用できます。', clerkPending: 'Clerk の公開キーまたは秘密キーがありません。', lemonReady: '決済ページと webhook キーの準備ができています。', lemonPending: 'Lemon Squeezy の checkout URL または webhook secret がありません。', supabaseReady: '会員同期と状態確認を利用できます。', supabasePending: 'Supabase URL または service role key がありません。' } },
  de: { metadataTitle: 'Standardmitgliedschaft MVP', badge: 'STANDARD MEMBERSHIP MVP', title: 'Standardmitgliedschaft', accent: 'Eine funktionsfähige Minimalversion', description: 'Diese Version verbindet Anmeldung, Zahlungen, Webhook-Updates und das Mitgliederzentrum zu einem vollständigen Mitgliedschaftsablauf.', setupTitle: 'Einrichtungsstatus', flowTitle: 'So funktioniert es', mvpTitle: 'MVP-Hinweis', signup: 'Konto erstellen', signin: 'Bereits ein Konto? Anmelden', checkout: 'Zur Abonnement-Zahlung', clerkBox: 'Clerk Identitäts-Anmeldung / Registrierung', lemonBox: 'Lemon Squeezy Abonnement-Zahlung', supabaseBox: 'Supabase Synchronisierung des Mitgliedsstatus', memberBox: 'Mitgliederzentrum und geschützte Seiten', ready: 'Bereit', pending: 'Ausstehend', stepTitles: ['1. Mitgliedsidentität erstellen', '2. Abonnement-Zahlung abschließen', '3. Mitgliederzugriff aktivieren'], stepTexts: ['Erstellen Sie Ihr Anmeldekonto mit Clerk. Alle Statusupdates werden Ihrer E-Mail-Adresse zugeordnet.', 'Schließen Sie die Zahlung über die offizielle Lemon-Squeezy-Abonnementseite ab. Das Ergebnis wird automatisch in Supabase zurückgeschrieben.', 'Nach Verarbeitung des Webhooks wird die Mitgliedschaft als aktiv markiert und der verfügbare Status wird sichtbar.'], mvpNote: 'Die Lemon-Squeezy-Checkout- und Webhook-Anbindung ist vorbereitet. Die Produktions-Zahlungs-URL und das Webhook-Secret müssen noch in der Deployment-Umgebung hinterlegt werden.', banners: { clerk: 'Clerk-Hinweis: Anmeldung, Registrierung und Identitätsprüfung müssen bereit sein.', lemon: 'Lemon-Squeezy-Hinweis: Checkout-URL und Webhook-Secret eintragen.', error: 'Einige Einstellungen fehlen noch. Prüfen Sie Clerk, Lemon Squeezy und Supabase.' }, details: { clerkReady: 'Anmeldung, Registrierung und Identitätsprüfung sind bereit.', clerkPending: 'Der öffentliche Clerk-Schlüssel oder der Secret Key fehlt.', lemonReady: 'Checkout-Seite und Webhook-Schlüssel sind bereit.', lemonPending: 'Die Lemon-Squeezy-Checkout-URL oder das Webhook-Secret fehlt.', supabaseReady: 'Mitgliedschaftssynchronisierung und Statusabfrage sind bereit.', supabasePending: 'Die Supabase-URL oder der Service-Role-Key fehlt.' } },
  es: { metadataTitle: 'MVP de membresía estándar', badge: 'STANDARD MEMBERSHIP MVP', title: 'Membresía estándar', accent: 'Una versión mínima que realmente funciona', description: 'Esta versión conecta inicio de sesión, pagos, actualizaciones por webhook y el centro de miembros en un flujo completo de membresía.', setupTitle: 'Estado de configuración', flowTitle: 'Cómo funciona', mvpTitle: 'Nota del MVP', signup: 'Crear una cuenta', signin: '¿Ya tiene una cuenta? Inicie sesión', checkout: 'Ir al pago de suscripción', clerkBox: 'Inicio de sesión / registro de identidad Clerk', lemonBox: 'Pago de suscripción Lemon Squeezy', supabaseBox: 'Sincronización de estado de membresía Supabase', memberBox: 'Centro de miembros y páginas protegidas', ready: 'Listo', pending: 'Pendiente', stepTitles: ['1. Cree su identidad de miembro', '2. Complete el pago de suscripción', '3. Active el acceso de miembro'], stepTexts: ['Cree su cuenta de inicio de sesión con Clerk. Todas las actualizaciones de membresía se vincularán a su correo electrónico.', 'Complete el pago mediante la página oficial de suscripción de Lemon Squeezy. El resultado se escribe automáticamente en Supabase.', 'Después de procesar el webhook, la membresía queda marcada como activa y el miembro puede ver el estado disponible.'], mvpNote: 'La conexión de checkout y webhook de Lemon Squeezy está preparada. Aún debe configurar la URL de pago de producción y el secreto del webhook en el entorno de despliegue.', banners: { clerk: 'Nota de Clerk: confirme que el inicio de sesión, el registro y la verificación de identidad estén listos.', lemon: 'Nota de Lemon Squeezy: introduzca la URL de checkout y el secreto del webhook.', error: 'Aún falta parte de la configuración. Revise Clerk, Lemon Squeezy y Supabase.' }, details: { clerkReady: 'El inicio de sesión, registro y verificación de identidad están listos.', clerkPending: 'Falta la clave pública o secreta de Clerk.', lemonReady: 'La página de checkout y la clave webhook están listas.', lemonPending: 'Falta la URL de checkout o el secreto webhook de Lemon Squeezy.', supabaseReady: 'La sincronización de membresía y la consulta de estado están listas.', supabasePending: 'Falta la URL de Supabase o la clave de rol de servicio.' } },
});
